 ...
 *
 */
   public static double[] readPels(String inFileName)
      {
      String outFileName;
      int i, j, k;
      int numberOfColors;
 ...
 */
      ...
      if ((bmpInfoHeader_biWidth < 33) && (bmpInfoHeader_biHeight < 33))
         ...
         double[] pels = new double[bmpInfoHeader_biHeight*bmpInfoHeader_biWidth];
/*
            ...
            for (j = 0; j < bmpInfoHeader_biWidth; ++j) // and the columns
               {
                  ...
                  pels[counter] = dibdumper.pelToRGB(pel).blue/256.0;

//                          (((pel & 0x00FF)/256.0) +
//                          (((pel >> 8) & 0x00FF)/256.0) +
//                          (((pel >> 16) & 0x00FF)/256.0))/3.0;
                  counter++;
